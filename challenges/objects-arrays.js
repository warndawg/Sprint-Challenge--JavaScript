...
const tyrannosaurus = {"name":"tyrannosaurus", 'diet':"concarnivorous", "weight":"7000kg", "length":"12m", "period":"Late Cretaceous", "roar": ()=>"RAWERSRARARWERSARARARRRR!"}
...
const uni = graduates.filter((hasUni)=> hasUni.university.includes("Uni"));
console.log(uni);
...
*/
const animalNames = zooAnimals.map((nameSci)=> "Name: " + nameSci.animal_name + ", Scientific: " + nameSci.scientific_name);
